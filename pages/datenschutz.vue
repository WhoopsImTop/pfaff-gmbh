  ...
  <div class="content-container">
    ...
    <div class="entry-content" itemprop="text">
      <div style="word-wrap: break-word">
        ...
        <p>
          Telefon: +49 (0) 7681 49397-0<br />
          E-Mail: info@pfaffgmbh.com
        </p>
        <p>
        ...
        <p>
          Telefon: 07681-49397-15<br />
          E-Mail: a.buff@pfaffgmbh.com
        </p>
        <h3>
        ...
        <p>
          ...
          verschiedene Nutzungsdaten, wie z.&nbsp;B. Seitenaufrufe,
          Verweildauer, verwendete Betriebssysteme und Herkunft des Nutzers.
          Diese Daten werden dem jeweiligen Endgerät des Users zugeordnet. Eine
        ...
        <p>
          ...
          Nutzung von Google Fonts erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
        ...
        <p>
          ...
          <strong
            >Der Betroffene kann seine Einwilligung jederzeit
            widerrufen.</strong
          >
